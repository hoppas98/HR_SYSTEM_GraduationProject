...
def get_requested_employees(request):
    ...
    decision_making_q1 = [0, 100, 75, 50, 25]
    decision_making_q2 = [0, 100, 75, 50, 25]
    decision_making_q3 = [0, 100, 75, 50, 25]
    decision_making_q4 = [0, 100, 75, 50, 25]
    decision_making_q5 = [0, 100, 75, 50, 25]
    decision_making_q6 = [0, 100, 75, 50, 25]
    decision_making_q7 = [0, 100, 75, 50, 25]
...
def view_applicant_report(request, user_email):
    ...
    for x in range(len(interview_results)):
        print(decision_making_q1[int(interview_results[x]['DM_A1'])])
        float
        decision_making_score = 0
        float
        team_worker_score = 0
